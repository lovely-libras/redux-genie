...
describe("THESE ARE THE RAILS TESTS THAT SHOULD PASS Rails", () => {
...
describe("ONE generate method- Rails", () => {
	...
	// 	const store = require("../../store/store").default
	// 	const { getAll } = require("../../store/actions/thunks_for_Campus").default; 
	// 	chai.use(sinonChai);
...
// describe("THREE Second set of tests for Ducks", () => {
